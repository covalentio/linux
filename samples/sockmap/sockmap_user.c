...
run:
	...
	if (test == PING_PONG)
		...
		err = sendmsg_test(iov_count, length, rate, verbose, false, false);
	else if (test == SENDPAGE)
		err = sendmsg_test(iov_count, length, rate, verbose, false, true);
	else if (test == BASE)
		err = sendmsg_test(iov_count, length, rate, verbose, true, false);
	else if (test == BASE_SENDPAGE)
		err = sendmsg_test(iov_count, length, rate, verbose, true, true);
	else
